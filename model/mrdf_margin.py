...
class MRDF_Margin(LightningModule):
    ...
    def loss_fn(self, m_logits, v_feats, a_feats, v_embeds, a_embeds, v_label, a_label, c_label, m_label) -> Dict[str, Tensor]:
    ...
    def training_step(self, batch: Optional[Union[Tensor, Sequence[Tensor]]] = None, batch_idx: Optional[int] = None,
        ...
        m_logits, v_feats, a_feats, v_embeds, a_embeds = self(batch['video'], batch['audio'], batch['padding_mask'])
        loss_dict = self.loss_fn(m_logits, v_feats, a_feats, v_embeds, a_embeds, batch['v_label'], batch['a_label'],
